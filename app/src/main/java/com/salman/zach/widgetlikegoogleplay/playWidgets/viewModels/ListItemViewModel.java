...
public class ListItemViewModel extends BaseObservable implements ViewModel {
    ...
    public static void setImage(ImageView image, ListItemViewModel model) {
        if (model.getImageResource() != 0) {
    ...
    public int getLayoutId() {
        return R.layout.item_play_listing_widget;
    }
